...
class ImagenetTransform:
    def __init__(
        ...
        # gaussian blur
        self.random_gaussian_blur = RandomGaussianBlur(prob=gaussian_prob, device=self.device)
...
class ContrastivePipeline(Pipeline):
    def __init__(
        ...
        # color/grayscale/gaussian/solarization transform
    ...
    def define_graph(self):
        ...
        # crop into large and small images
        crops = []
        for i in range(len(self.n_crops)):
